...
(
 ...
 CATEGORYKEY      number(38,0) NOT NULL COMMENT 'The ''CategoryKey'' column contains data related to ''categorykey''.',

 CONSTRAINT PK_1 PRIMARY KEY ( FEEDBACKID ),
 CONSTRAINT FK_1 FOREIGN KEY ( CATEGORYKEY ) REFERENCES SUPPLYCHAIN.CATEGORYDIM_T ( CATEGORYKEY )
);
