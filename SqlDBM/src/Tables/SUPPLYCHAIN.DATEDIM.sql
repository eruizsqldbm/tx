...
(
 ...
 WAREHOUSEOPERATIONID number(38,0) NOT NULL COMMENT 'The unique identifier for warehouse operation.',

 CONSTRAINT DATEKEY PRIMARY KEY ( DATEKEY ),
 CONSTRAINT FK_1 FOREIGN KEY ( WAREHOUSEOPERATIONID ) REFERENCES SUPPLYCHAIN.WAREHOUSEOPERATIONSFACT ( WAREHOUSEOPERATIONID )
)
