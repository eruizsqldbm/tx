...
(
 ...
 HIREDATE1 date COMMENT 'The ''HireDate'' column contains data related to ''hiredate''. This column stores information related to dates or times.',

 CONSTRAINT PK_1 PRIMARY KEY ( USERID )
)
COMMENT = 'A table that is for our Users.';
