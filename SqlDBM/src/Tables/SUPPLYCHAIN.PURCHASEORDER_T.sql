...
(
 PURCHASEORD_ID number(38,0) NOT NULL AUTOINCREMENT START 1 INCREMENT 1 COMMENT 'The ''PurchaseOrderID'' column contains data related to ''purchaseorderid''. This column likely represents an identifier.',
 ...
 CONSTRAINT PK_1 PRIMARY KEY ( PURCHASEORD_ID ),
