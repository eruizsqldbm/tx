...
(
 ORD_ID       number(38,0) NOT NULL AUTOINCREMENT START 1 INCREMENT 1 COMMENT 'The ''OrderID'' column contains data related to ''orderid''. This column likely represents an identifier.',
 ...
 CONSTRAINT PK_1 PRIMARY KEY ( ORD_ID ),
