...
(
 S_ID         number(38,0) NOT NULL AUTOINCREMENT START 1 INCREMENT 1 COMMENT 'The ''SupplierID'' column contains data related to ''supplierid''. This column likely represents an identifier.',
 ...
 CONSTRAINT PK_1 PRIMARY KEY ( S_ID )
