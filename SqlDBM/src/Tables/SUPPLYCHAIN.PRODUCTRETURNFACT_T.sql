...
(
 ...
 ORD_ID           number(38,0) NOT NULL COMMENT 'The ''OrderID'' column contains data related to ''orderid''. This column likely represents an identifier.',
 ...
 CONSTRAINT FK_14 FOREIGN KEY ( ORD_ID ) REFERENCES SUPPLYCHAIN.ORDERS_T ( ORD_ID )
);
